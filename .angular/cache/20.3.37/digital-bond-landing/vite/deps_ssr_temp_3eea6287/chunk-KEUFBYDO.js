...
import {
  ...
  Router,
  loadChildren
} from "./chunk-IYVHQ4YM.js";
import {
  BrowserDomAdapter,
  BrowserModule,
  EVENT_MANAGER_PLUGINS,
  EventManagerPlugin
} from "./chunk-ZI7TAEGT.js";
import {
  HTTP_ROOT_INTERCEPTOR_FNS
} from "./chunk-II6TK47J.js";
import {
  APP_BASE_HREF,
  ...
  getDOM,
  setRootDomAdapter
} from "./chunk-YYG6TRC2.js";
import {
  XhrFactory
} from "./chunk-EWTGJJYR.js";
import {
  APP_ID,
  ApplicationRef,
  CSP_NONCE,
...
function requireNodeUtils() {
  ...
  function findCommentEnd(rawText, index2) {
    if (rawText.charAt(index2) === ">") return index2 + 1;
    if (rawText.charAt(index2) === "-" && rawText.charAt(index2 + 1) === ">") return index2 + 2;
...
//# sourceMappingURL=chunk-KEUFBYDO.js.map
